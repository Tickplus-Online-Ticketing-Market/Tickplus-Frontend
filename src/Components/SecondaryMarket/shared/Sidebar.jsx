...
import { DASHBOARD_SIDEBAR_BOTTOM_LINKS, DASHBOARD_SIDEBAR_LINKS } from '../lib/constants/sidebarNav'
    ...
    return (
        <div className="flex flex-col h-screen w-1/5 bg-accent p-3 text-white  ">
            ...
            <div className="flex flex-col gap-0.5 pt-2 ps-4 pb-3">
                ...
                <div className={classNames(sidebarNavLinkClasses, 'px-3', 'cursor-pointer')}>
...
function SidebarLink({ item }) {
    ...
    return (
        <Link to={item.path} className={classNames(sidebarNavLinkClasses, hoverStyle)}>
