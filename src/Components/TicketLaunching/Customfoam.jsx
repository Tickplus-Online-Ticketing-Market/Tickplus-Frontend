    ...
    <div>
      <div className="fixed inset-0 bg-accent bg-opacity-0 backdrop-blur-sm flex justify-center items-center shadow-2xl">
        <div className="bg-secondary shadow-2xl border border-primary outline-transparent h-[37rem] w-2/5 p-2 rounded-lg">
          ...
          <div className="text-accent font-bold text-2xl pl-4 pb-2">
            Enter your Name
          </div>
          <div className="pl-4 pb-2 ">
            <input
              ...
              className="mt-1 block w-[28rem] p-2 border-gray-300 rounded-md shadow-lg text-base"
              placeholder="Your full name"
            />
            {nameError && <div className="text-red text-base">{nameError}</div>}
          </div>
          ...
          {phoneError && <div className="text-red text-base">{phoneError}</div>}
          ...
          >
            ...
            <div className="text-base pl-3 pb-2">
              ...
              offered by Tickplus for event tickets. By using our Services, you
            ...
            <div className="text-base pl-3 pb-2">
              1. <strong className="font-semibold">Order Submission:</strong>{" "}
              Customers must provide accurate and complete information when
              placing an order for ticket customization.
            </div>
            <div className="text-base pl-3 pb-2">
              2. <strong className="font-semibold">Proof Approval:</strong> Once
              the customization is done, we will provide a proof for your review
              and approval. It is your responsibility to review the proof
              carefully for any errors or discrepancies.
            </div>
            <div className="text-base pl-3 pb-2">
              3. <strong className="font-semibold">Approval Deadline:</strong>{" "}
              Any delays in approving the proof beyond the specified deadline
              may result in delays in the delivery of the customized tickets.
            </div>
            <div className="text-xl font-semibold m-2 pl-2">Payment Terms</div>
            <div className="text-base pl-3 pb-2">
              1. <strong className="font-semibold">Payment:</strong> Payment for
              the Services is due at the time of order placement unless
              otherwise agreed upon in writing.
            </div>
            <div className="text-base pl-3 pb-2">
              1. <strong className="font-semibold">Refunds:</strong> Customized
              tickets are non-refundable once the customization process has
              begun.
            </div>
            <div className="text-xl font-semibold m-2 pl-2">Contact Us</div>
            <div className="text-base pl-3 pb-2">
              If you have any questions or concerns regarding these terms and
              conditions, please contact us at Tickplus@lk
            </div>
          </div>
