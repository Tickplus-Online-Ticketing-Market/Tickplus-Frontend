...
export default function Delete({ visible, onClose, onDelete }) {
  ...
  return (
    ...
    >
      <div className="bg-secondary h-28 w-60 p-2 rounded">
        <div className="font-bold text-primary flex justify-center text-2xl pt-2 pb-4">
          Confirm Delete?
        </div>
        <div className="flex justify-between gap-3 ">
          <button
            onClick={handleConfirmDelete}
            class="bg-accent h-full w-full font-bold rounded-full py-2 text-background
          ...
          <button
            className="bg-primary h-full w-full font-bold rounded-full py-2 text-background 
