...
export default function BuyModel({ visible, onClose, selectedItem }) {
        ...
        <div
            ...
            <div className='bg-background h-[30rem] w-[50rem] rounded-xl flex justify-between items-center'>
                ...
                <div className='bg-background rounded-xl h-[30rem] w-[50%]'>
                    ...
                    <p className="text-primary font-bold text-2xl flex flex-col justify-center items-center"> {/*Total Cost*/}</p>
                </div>    
            </div>  
        </div>
    );
