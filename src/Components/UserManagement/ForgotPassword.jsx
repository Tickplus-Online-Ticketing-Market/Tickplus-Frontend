    ...
    <div>
      <form onSubmit={handleResetPassword}>
        <section className="text-text body-font relative grid place-items-center mt-10">
          <div className="mb-6 bg-primary bg-opacity-100 w-1/2 rounded-2xl p-8">
            <h2 className="text-accent text-2xl mb-1 font-bold title-font">
              Reset Password
            </h2>

            <label
              htmlFor="email"
              className="leading-7 text-base text-background"
            >
              Email:
            </label>
            <input
